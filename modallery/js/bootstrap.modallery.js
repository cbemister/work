  ...
  $.fn.modallery = function( options ) {
    ...
    if (params.navigate) {
      ...
      $(params.caller).each(function(){
        var btn  = '<button style="" class="navigator-btn" data-ref="' + $(this).data('to') +'" data-code='+i+'><img src="'+$(this).attr('src')+'" class="img-responsive" /></button>';
      ...
      if (params.arrows) {
        ...
        $("#mdlyFooter").html('<button class="btn btn-primary" id="previousMdly">«</button><button class="btn btn-primary" id="nextMdly">»</button><div class="row"><div class="col-sm-12" style="display:flex;flex-wrap: wrap;">' + html  + '</div></div>');
      }
    }
