$(document).ready(function () {
 ...
 function mCallback(mutations) {
  ...
  for (let mutation of mutations) {
   ...
   if (mutation ? mutation.addedNodes[0] ? mutation.classList && mutation ? mutation.addedNodes[0].classList[0] === 'vehicle-card' || mutation ? mutation.addedNodes[0] ? mutation.classList && mutation ? .addedNodes[0].classList[0] === 'mb-lg') {
