...
var customVLP = (function () {
	...
	$.when($.ajax({
			...
			success: function (html) {
				...
				var qtyInStock = $(html).find('.ddc-content.inventory-listing-default .mobile-vlp-in-stock.pull-left > strong').first().text();
		...
		.then(function () {
			...
			$.when.apply($, paginationArray.map(function (url) {
				...
				//$('.page-bd .ddc-content.inventory-listing-default').prepend('<div class="mobile-vlp-in-stock inventoryCount"><strong>' + count + '</strong>'+ ' ' + year ? year : ''; + ' ' + model ? model : ''; + ' Vehicles in stock</div>');
				var inventoryLabel = (year ? year : '') + ' ' + (model ? model : '');

$('.page-bd .ddc-content.inventory-listing-default').prepend('<div class="mobile-vlp-in-stock inventoryCount"><strong>' + count + '</strong>'+ ' ' + inventoryLabel + ' Vehicles in stock</div>');
